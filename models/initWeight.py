...
exp2IniFunc = {
    ...
    "0329_5": lambda weight: torch.nn.init.uniform_(weight, -2, 2),
    "0329_6": lambda weight: torch.nn.init.uniform_(weight, -1, 1),
    "0329_7": lambda weight: torch.nn.init.uniform_(weight, -1./2, 1./2),
    "0329_8": lambda weight: torch.nn.init.uniform_(weight, -0.25, 0.25),
    "0329_9": lambda weight: torch.nn.init.uniform_(weight, -0.25/2, 0.25/2),
    "0329_10": lambda weight: torch.nn.init.uniform_(weight, -0.1/2, 0.1/2), 
    "0329_11": lambda weight: torch.nn.init.uniform_(weight, -0.05/2, 0.05/2),
    ...
    "0329_18": lambda weight: torch.nn.init.normal_(weight, 0, 1/4),
